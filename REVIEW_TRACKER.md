...
| B3 | **Beta-thalassaemia is load-bearing** — it is currently the *entire* base-editable bucket in gate 2, on a medium-confidence call. *ClinVar reports **415** distinct pathogenic HBB alleles, confirming the heterogeneity but not resolving the split. Needs HbVar or a patient-series allele frequency table.* | 1 condition | ☐ |
