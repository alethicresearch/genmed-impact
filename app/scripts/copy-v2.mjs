...
// Static hosts have no SPA rewrite for /v2 or /v3, so each route gets its own copy of the
// built entry point plus the relative asset/data directories it expects. Netlify can still
